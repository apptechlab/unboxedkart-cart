...
{/* <div className="flex flex-row">
          <h1 className="font-trebuchet text-3xl text-white font-bold my-4 font-trebuchet">
            Unboxedkart
          </h1>
        </div> */}

{/* <h1 className="text-white text-xl pl-4 mr-20 mb-10 font-trebuchet">
          Buy Premium Pre-owned Products at Affordable Prices
        </h1> */}