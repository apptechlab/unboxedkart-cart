  ...
  const features = [
    {
      ...
      desc: "We are here for you and we will fix all your Apple devices",
      link: "/",
    },
    {
      id: 2,
      ...
      title: "Quick Fix",
      desc: "You can avail 24 hours service option, which is applicable on particular repair services.",
      link: "/",
    },
    {
      id: 3,
      ...
      title: "Service at your door step",
      desc: "Pick-up and delivery option is available at minimal price",
      link: "/",
    },
    {
      id: 4,
      ...
      desc: "Skilled and certified technicians lead to quality service.",
      link: "/",
    },
    {
      id: 5,
      ...
      title: "Authentic parts with warranty (120 Days)",
      desc: "We use the best quality spare parts, which are certified by Unboxedkart.",
      link: "/",
    },
    {
      id: 6,
      ...
      title: "All in One",
      desc: "We fix all your Apple products",
      link: "/",
    },
  ];

  return (
    <section className="bg-unboxedkartBlue h-auto md:h-screen text-white flex flex-col gap-y-2 justify-center items-center p-3 pt-10 md:pt-0">
      <h2 className="text-center text-2xl md:text-4xl font-bold text-white">
        Why Unboxedkart Service ?
      </h2>
      <p className="text-md">Let us tell you some thing...</p>
